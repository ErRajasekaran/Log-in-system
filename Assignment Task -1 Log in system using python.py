                    ...
                    if user_name[0] not in ('@','_','!','#','$','%','^','&','*','(',')','<','>','?','/','|','}','','~',':'):
                        if any(char.isdigit() for char in password):
                            if any(char.isupper() for char in password):
                                ...
                                print("The password must contain a special character a uppercase and lower case letter and a number c")
                                user_name=input("Enter your user_name: ")
                                password=input("Enter your password: ")
                                sign_up(user_name,password)
                                
                        else:
                            print("The password must contain a special character a uppercase and lower case letter and a number d")
                            user_name=input("Enter your user_name: ")
                            password=input("Enter your password: ")
                            sign_up(user_name,password)
                    else:
                        print("The password must contain a special character a uppercase and lower case letter and a number e")
                        user_name=input("Enter your user_name: ")
                        password=input("Enter your password: ")
                        sign_up(user_name,password)
                else:
